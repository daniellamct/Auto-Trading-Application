...
print("Training Data:")
mse = mean_squared_error(y_train, y_train_rf_pred)
r2 = r2_score(y_train, y_train_rf_pred)
...
r2_test = r2_score(y_test, y_test_rf_pred)
...
plt.subplot(1, 2, 1)
plt.scatter(y_train, y_train_rf_pred, alpha=0.5, color='blue', label='Predictions')
...
plt.subplot(1, 2, 2)
plt.scatter(y_test, y_test_rf_pred, alpha=0.5, color='green', label='Predictions')
